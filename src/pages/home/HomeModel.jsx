...
export default class HomeModel extends Component {
  ...
  render() {
    ...
    AOS.init();
    return (
      <div className='bg-[#f2f2f7] text-[#282a2f] dark:text-[#cccbcb] dark:bg-[#121212] duration-200 h-screen jakarta-400 tracking-wide flex flex-col items-center gap-72 py-10'>
        ...
        <div className='relative'>
          <div className='flex items-center gap-10'>
            <div className='navigation-box flex flex-col items-center gap-5 cursor-pointer' data-aos="fade-up" data-aos-duration="500">
              <Link to="/">
                <div className='bg-[#E5E5EA] dark:bg-black duration-200 navigation-button p-5 rounded-xl '>
            ...
            <div className='navigation-box flex flex-col items-center gap-5 cursor-pointer' data-aos="fade-up" data-aos-duration="500" data-aos-delay="100">
              <Link to="/project">
                <div className='bg-[#E5E5EA] text-black dark:text-white dark:bg-black duration-200 navigation-button p-5 rounded-xl '>
