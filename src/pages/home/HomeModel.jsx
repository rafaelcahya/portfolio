...
export default class HomeModel extends Component {
  ...
  render() {
    ...
    AOS.init();
    return (
      <div className='bg-[#eceef0] text-[#282a2f] dark:text-[#cccbcb] dark:bg-black duration-200 h-screen jakarta text-[13px] tracking-wide flex flex-col items-center gap-72 py-10'>
        ...
        <div className='status absolute'>
          <div className='flex flex-col items-center'>
            <a href={"" + article.fields.hyperlink} target={'_blank'} rel="noreferrer" className='logo rounded-xl'>
