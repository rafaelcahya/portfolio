...
import ModelWorkJourney from './GridModelWorkJourney'

export class GridWorkJourney extends Component {
    constructor() {
        super()
    ...
    render() {
        const articles = this.state.articles.map((article, i) => <ModelWorkJourney id={i} key={i} article={article}/>)
        if(!articles){
            return <Loading/>
        }
        return (
...
export default GridWorkJourney