    ...
    render() {
        return (
            !this.state.article ? <Loading/> : (
                <>
                    <Navbar/>
                    <div className='bg-[#eceef0] text-[#48484a] dark:text-[#f4f4f4] dark:bg-[#10101A] duration-200 jakarta tracking-wider'>
                        <div className='flex h-screen'>
                            <div className='m-auto flex flex-col gap-8 text-center'>
                                ...
                                <div>
                                    <p className='text-[20px]' data-aos='fade-up' data-aos-easing="ease-out" data-aos-delay="100" data-aos-duration="500">{this.state.article.fields.type}</p>
                                </div>
                            </div>
                        </div>
                        <div className='flex flex-col gap-72 py-32 px-5'>
