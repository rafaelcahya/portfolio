    ...
    render() {
        ...
        return (
            <div className="timeline-item tracking-wide" data-aos="fade-zoom-in" data-aos-duration="500" data-aos-offset="0">
                <div className='jakarta text-[14px] text-[#282a2f] dark:text-[#cccbcb] duration-200 flex gap-1'>
                ...
                <Link to={`/project/${article.fields.slug}`} className="timeline-item-content bg-[#E5E7EB] hover:bg-[#dcdee1] dark:bg-black dark:hover:bg-[#0c0c0c] gap-4 text-[#282a2f] dark:text-[#cccbcb] duration-200">
