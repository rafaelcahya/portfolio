...
export default class CurrentlyProjectNoteModel extends Component {
    render() {
        ...
        return <div className='jakarta text-[14px] tracking-wider leading-8 text-[#48484a] dark:text-[#cccbcb] flex flex-col md:flex-row justify-center gap-5 md:gap-32 mx-20'>
